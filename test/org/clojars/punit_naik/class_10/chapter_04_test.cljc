...
(deftest middle-term-splittable?-test
  ...
  (is (ch-04/middle-term-splittable? [3 (- (* 2 (math/sqrt 6.0))) 2]
                                     [(* -1 (math/sqrt 6.0)) (* -1 (math/sqrt 6.0))])))
...
(deftest split-middle-term-test
  ...
  (is (= [-2.449489742783178 -2.449489742783178] (ch-04/split-middle-term [3 (- (* 2 (math/sqrt 6.0))) 2]))))
...
(deftest solve-quadratic-eqation-test
  ...
  (is (= [0.8164965809277261 0.8164965809277261] (ch-04/solve-quadratic-eqation [3 (- (* 2 (math/sqrt 6.0))) 2] :factorisation))))
